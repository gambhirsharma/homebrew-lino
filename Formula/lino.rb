class Lino < Formula
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      sha256 "sha256:3939db3e66219b0a1e002abf822443fed6261e67c1b0d031112d2db8009ef856"
    elsif Hardware::CPU.is_32_bit?
      url "https://github.com/CGI-FR/LINO/releases/download/v#{version}/LINO_#{version}_linux_386.tar.gz"
      sha256 "sha256:e1b37706c8fffa51b663257012b7d9a123272a19beffe39dfb2911528a2bf066"
    end
  end
